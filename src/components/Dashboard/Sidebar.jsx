...
const Sidebar = () => {
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <div
                className={`fixed top-0 left-0 h-full w-50 bg-white shadow-sm border-r border-gray-200 flex flex-col pb-10 z-10 transition-transform duration-300 ease-in-out ${isSidebarOpen ? "translate-x-0" : "-translate-x-full"
                    } md:translate-x-0`}
            >
                {/* Logo */}
