...
import { Monitor, MonitorCheck, Upload } from "lucide-react";
...
export default function EditShopForm() {
    ...
    const [formData, setFormData] = useState({
        ...
        profitShare: shopData.profitShare || "0%",
        feedSource: shopData.feedSource || "",
        logo: shopData.logo || null,
        miniStack: shopData.miniStack || "",
        maxStack: shopData.maxStack || "",
        status: shopData.status || "active", // <-- added for radio button
    });
