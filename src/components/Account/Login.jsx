...
export default function Login() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-gray-100">
            <div className="min-h-[310px] max-w-[880px] w-full flex justify-center items-center mx-auto bg-white border border-gray-200 shadow-lg">
                {/* Left Side - Welcome Section */}
                <div className="flex-1 w-90 bg-gradient-to-br bg-[#3040D6] flex flex-col justify-center items-center p-12 h-120 text-white">
                    <div>
                        <h1 className="text-4xl font-light mb-2">Welcome to Kiron</h1>
                        <h2 className="text-4xl font-light mb-8">Interactive</h2>
                        <p className="text-lg mb-12 opacity-90">Please login to continue</p>
                        {/* Hexagonal Icons */}
                        <div className="flex flex-col justify-center items-center ">
                            <div className="flex space-x-2 text-white ">
                                <svg width="82" height="91" viewBox="0 0 152 169" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div className="flex space-x-2 text-white mt-[-12px]">
                ...
                <div className="flex-1 h-120   bg-gray-50 flex flex-col justify-center items-center p-12">
                        ...
                        <form onSubmit={handleLogin} className="space-y-6 w-full max-w-lg mx-auto">
                            <div>
                                <Label htmlFor="username" className="text-sm font-medium text-gray-700">
                                    <span className="text-green-500 mr-1">*</span>Username
                                </Label>
                                <Input
                                    id="username"
                                    type="text"
                            ...
                            <div>
                                <Label htmlFor="password" className="text-sm font-medium ">
                                    <span className="text-green-500 mr-1">*</span>Password
                                </Label>
                                <Input
                                    id="password"
                                    type="password"
                            ...
                            <div className="flex justify-center">
                                <Button
                                    type="submit"
                                    className="w-[100px] flex justify-center items-center bg-[#263FE6] hover:bg-blue-700 text-white font-semibold py-2"
                                >
